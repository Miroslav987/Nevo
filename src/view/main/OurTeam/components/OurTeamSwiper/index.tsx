...
const OurTeamSwiper = () => {
  ...
  return (
    <div className={styles.ourTeamSwiper}>
      <Swiper {...settingOurTeamSwiper} onSwiper={setImageSwiper} className={styles.swiperImage}>
        {ourTeam.map((e, i) => (
      ...
      <div className={styles.sectionSwiperAndNav}>
        <Swiper {...settingOurTeamSwiper} onSwiper={setTextSwiper} className={styles.swiperText}>
          {ourTeam.map((e, i) => (
            <SwiperSlide key={i} className={styles.slideText}>
              ...
              >
                ...
                <Text className={styles.quote}>{e.quote}</Text>
              </motion.div>
            </SwiperSlide>
          ))}
        </Swiper>
